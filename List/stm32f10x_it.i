#line 1 "Src\\StdPeriph_Driver\\stm32f10x_it.c"
...
#line 20 "Src\\StdPeriph_Driver\\stm32f10x_it.c"
#line 1 "Src\\StdPeriph_Driver\\stm32f10x_it.h"
...
#line 21 "Src\\StdPeriph_Driver\\stm32f10x_it.c"
...
extern char buf1[32];
  ...
  if(USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0020)) == SET) 
	  {
    	*(buf1+buf1Pos)= USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
			if(*(buf1+buf1Pos)=='\n')
			{
				*(buf1+buf1Pos)='\0';
			ScanfFlag=1;
				...
				if(strcmp(buf1,"help")==0) printf1("\nhelp test adc1  adc1c100 adc1c10000\n");
