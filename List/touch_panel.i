...
#line 2 "Src\\BSP\\touch_panel.c"
#line 3 "Src\\BSP\\touch_panel.c"
...
#line 6 "Src\\BSP\\touch_panel.c"

#line 17 "Src\\BSP\\touch_panel.c"

void touchPanelInit(){
    GPIO_InitTypeDef GPIO_InitStructure;
    SPI_InitTypeDef  SPI_InitStructure;
    
    RCC_APB2PeriphClockCmd(((uint32_t)0x00001000) | ((uint32_t)0x00000080) |((uint32_t)0x00000004), ENABLE);
    ...
    GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0010), !0);
...
u8  touch_panel_read(u16 *X, u16 *Y) {
    ...
    while(i < 10 && (!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0400)))) {
        GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0010), !1);
        
        SPI_Exchange_Data(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), 0xD0);
        delay_us(6);
        
        X_temp = SPI_Exchange_Data(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), 0);
        X_temp = X_temp << 8;
        X_temp |= SPI_Exchange_Data(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), 0);
        X_temp >>= 3;

        SPI_Exchange_Data(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), 0x90);
        delay_us(6);

        Y_temp = SPI_Exchange_Data(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), 0);
        Y_temp = Y_temp << 8;
        Y_temp |= SPI_Exchange_Data(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3000)), 0);
        Y_temp >>= 3;
    ...
    if(i == 10) {
        ...
        *Y = 257 - X_temp*24/355;
        ...
        USART1_printf_line("left=%d, top=%d",*X, *Y);
