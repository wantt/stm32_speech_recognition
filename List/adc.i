...
#line 2 "Src\\BSP\\ADC.C"
#line 3 "Src\\BSP\\ADC.C"
...
void ADC_DMA_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000200) | ((uint32_t)0x00000004) | ((uint32_t)0x00000800), ENABLE);
	...
	TIM_OC1Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00)), &TIM_OCInitStructure);
	...
	DMA_InitStructure.DMA_BufferSize = ((8000/1000)*2000);
	...
	ADC_RegularChannelConfig(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), ((uint8_t)0x01), 1, ((uint8_t)0x05));
