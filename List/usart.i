...
#line 2 "Src\\BSP\\USART.C"
#line 3 "Src\\BSP\\USART.C"
...
#line 4 "Src\\BSP\\USART.C"
#line 5 "Src\\BSP\\USART.C"
...
{  u16 i;
    ...
    for(i = 0; * (fmt + i) != '\0'; i++) 
        USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), *(fmt + i));
}
...
void UASRT_DMA_TXConfiguration(USART_TypeDef *USARTx, u8 *BufferSRC, u32 BufferSize) {
    ...
    DMA_ClearFlag(((uint32_t)0x00002000) | ((uint32_t)0x00008000) | ((uint32_t)0x00004000) | ((uint32_t)0x00001000));
...
void USART1_printf(char *fmt, ...) {
    ...
    USART_SendStr(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), (u8 *)printfBuf);
    __va_end(arg_ptr);
}
...
void USART1_printf_line(char *fmt, ...) {
    ...
    USART_SendStr(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), (u8 *)printfBuf);
    USART_SendStr(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), "\r\n");
}
