...
{	 		  	  
	u32 temp;		   
	((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD=(u32)nms*((u16)(72/8)*1000);
...
{		
	u32 temp;	    	 
	((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD=Nus*(72/8); 
	((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL=0x00;        
	((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL=0x01 ;      
	do
	{
