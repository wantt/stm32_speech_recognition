...
#line 4 "Src\\GUI\\GUI.C"
#line 5 "Src\\GUI\\GUI.C"
...
#line 6 "Src\\GUI\\GUI.C"
#line 7 "Src\\GUI\\GUI.C"
...
#line 13 "Src\\GUI\\GUI.C"


#line 25 "Src\\GUI\\GUI.C"

GUI_Area Screen={0,0,320,240,0X07E0,0XF800};

GUI_Area Label[]=
{
	{106,19	,99	,28	,0X07E0,0X001F},
	{25	,56	,275,28	,0X07E0,0X001F},
	{40	,168,99	,28	,0XF81F ,0X001F},
	{179,168,99	,28	,0XF81F ,0X001F},
	
	{106,18	,99	,28	,0X07E0,0X001F},
	
	{16	,92	,28	,28	,0XFFE0 ,0X001F},
	{16	,55	,28	,28	,0XFFE0 ,0X001F},
	{48	,55	,28	,28	,0XFFE0 ,0X001F},
	{81	,55	,28	,28	,0XFFE0 ,0X001F},
	{114,55	,28	,28	,0XFFE0 ,0X001F},
	{146,55	,28	,28	,0XFFE0 ,0X001F},
	{179,55	,28	,28	,0XFFE0 ,0X001F},
	{212,55	,28	,28	,0XFFE0 ,0X001F},
	{244,55	,28	,28	,0XFFE0 ,0X001F},
	{277,55	,28	,28	,0XFFE0 ,0X001F},
	{48	,92	,28	,28	,0XFFE0 ,0X001F},
	{81	,92	,28	,28	,0XFFE0 ,0X001F},
	{114,92	,28	,28	,0XFFE0 ,0X001F},
	{146,92	,28	,28	,0XFFE0 ,0X001F},
	{179,92	,28	,28	,0XFFE0 ,0X001F},
	{212,92	,28	,28	,0XFFE0 ,0X001F},
	{244,92	,28	,28	,0XFFE0 ,0X001F},
	{277,92	,28	,28	,0XFFE0 ,0X001F},
	
	{24	,148,74	,28	,0XF81F ,0X001F},
	{122,148,28	,28	,0XFFE0 ,0X001F},
	{191,148,100,28	,0X07E0,0X001F},
	
	{24 ,194,140,28	,0X07E0,0X001F},
	{232,194,52 ,28	,0XF81F ,0X001F},

	
	{140,100,140,28	,0X07E0,0X001F},
	
	{85	,55	,140,28	,0XFFE0 ,0X001F},
	{70	,95	,170,28	,0XFFE0 ,0X001F},
};
...
void wait_touch(void)
{
	while(1)
	{
		while(!(!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0400))));
        USART1_printf_line("TSC_IN_TOUCH");
		if(touch_panel_read(&touch_left,&touch_top)!=0)
		{
			USART1_printf_line("left=%d, top=%d",touch_left,touch_top);
			while((!GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0400))))touch_panel_read(&touch_left,&touch_top);
			break;
		}
	}
}
...
void GUI_DispStr(GUI_Area *Area,const u8 *str)
{
	...
	while(*(str+i)!=0)
	{
		if(*(str+i)>'~')
		{
			if((left+24)>Area->Width)
			{
				left=0;
				top+=(24+1);
				if((top+24)>Area->Height)
				{
					return;
				}
			}
