...
#line 2 "Src\\BSP\\BSP.c"

#line 13 "Src\\BSP\\BSP.c"
...
void RCC_Configuration(void) {
    ...
    RCC_APB2PeriphClockCmd(((uint32_t)0x00004000) | ((uint32_t)0x00001000) |
                           ((uint32_t)0x00000008) | ((uint32_t)0x00000004) |
                           ((uint32_t)0x00000010) | ((uint32_t)0x00000020) |
                           ((uint32_t)0x00000040) | ((uint32_t)0x00000100) |
                           ((uint32_t)0x00000001)  | ((uint32_t)0x00000200), ENABLE);
...
void GPIO_Configuration(void) {
    ...
    GPIO_InitStructure.GPIO_Pin = ((uint16_t)0x2000) | ((uint16_t)0x0040);
